...
class OutputIngredientPage extends StatefulWidget {
  const OutputIngredientPage({super.key});

  @override
  State<OutputIngredientPage> createState() => _OutputIngredientPageState();
}

class _OutputIngredientPageState extends State<OutputIngredientPage> {
