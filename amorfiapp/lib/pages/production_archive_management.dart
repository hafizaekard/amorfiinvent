...
class _ProductionArchiveManagementPageState
  ...
  // Fungsi baru untuk menghitung tanggal kadaluwarsa
  String _getExpiryDate(String productTitle, DateTime productionDate) {
    String lowerTitle = productTitle.toLowerCase();
    int daysToAdd;

    if (lowerTitle.startsWith('roti')) {
      daysToAdd = 5;
    } else if (lowerTitle.startsWith('kue tart') ||
        lowerTitle.startsWith('bento cake')) {
      daysToAdd = 8;
    } else {
      return ''; // Tidak menampilkan reminder untuk produk lainnya
    }

    DateTime expiryDate = productionDate.add(Duration(days: daysToAdd));
                          ...
                          ListView.builder(
                            ...
                            itemBuilder: (context, itemIndex) {
                              ...
                              final String expiryDateStr =
                                  _getExpiryDate(productTitle, productionDate);
                                        ...
                                        child: Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              Expanded(
                                                child: Text(
                                                  'Produk akan kadaluwarsa pada $expiryDateStr',
                                                  style: TextStyle(
                                                    color: blackColor,
                                                    fontSize: 12,
