...
Color yellowColor = const Color(0xFFFFFF00);
Color purpleColor = const Color(0xFFAD49E1);
Color greenColor = const Color(0xFF06923E);
...
TextStyle orangeTextStyle = GoogleFonts.inter(color: orangeColor);
...
//Margin
const double deafultMargin = 20.0;