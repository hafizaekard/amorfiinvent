...
class IngredeientItemPage extends StatefulWidget {
  const IngredeientItemPage({super.key});

  @override
  State<IngredeientItemPage> createState() => _IngredeientItemPageState();
}

class _IngredeientItemPageState extends State<IngredeientItemPage> {
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: Center(
                                        child: Text(
                                          (itemQuantities[document.id] ?? 0).toString(),
                                          style: blackTextStyle.copyWith(
                                            fontSize: 16,
                                            fontWeight: bold,
                                          ),
