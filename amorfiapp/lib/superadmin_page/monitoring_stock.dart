...
class MonitoringStockPage extends StatefulWidget {
  const MonitoringStockPage({super.key});

  @override
  State<MonitoringStockPage> createState() => _MonitoringStockPageState();
}

class _MonitoringStockPageState extends State<MonitoringStockPage> {
