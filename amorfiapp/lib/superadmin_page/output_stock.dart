...
class OutputStockPage extends StatefulWidget {
  const OutputStockPage({super.key});

  @override
  State<OutputStockPage> createState() => _OutputStockPageState();
}

class _OutputStockPageState extends State<OutputStockPage> {
